    ...
    return (
      <div>
        <nav className="nav styles bg-light text-body">
          ...
          <Link className="nav-link text-body navFont " to="/">
            Home
          </Link>
          <Link className="nav-link text-body navFont" to="/admin">
            Admin
          </Link>
          <Link className="nav-link text-body navFont" to="/clearance">
            Clearance
          </Link>
          {/* <Link className="nav-link active" to='edit'>Edit</Link> */}
          <Link className="nav-link text-body " to="/cart">
            <i className="fa-solid fa-cart-shopping account"></i>
          </Link>

          <Link to="about" className="text-body navFont">
            About Me
          </Link>
        </nav>
      </div>
